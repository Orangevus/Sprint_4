...
public class CreateOrderTest {
    ...
    public static Object[][] getCredentials() {
        return new Object[][]{{"Header", "Александр", "Пушной", "Москва", "Черкизовская", "89096523125", "30.11.2020", "сутки", "чёрный жемчуг", "коммент"}, {"Main", "Анна", "Коренина", "Москва", "Сокольники", "89055583321", "28.11.2023", "двое суток", "серая безысходность", "коммент"},};
    }
